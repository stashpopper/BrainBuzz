...
function Login () {
    ...
    return (
        <main className="w-full h-screen flex flex-col items-center justify-center px-4 bg-white dark:bg-gray-950">
            <div className="max-w-sm w-full text-gray-600 dark:text-gray-300 space-y-5">
                ...
                <div className="mt-8">
                    <h3 className="text-gray-800 dark:text-white text-2xl font-bold sm:text-3xl">Log in to your account</h3>
                </div>
                </div>
                <form
