        ...
        <section className="py-8 sm:py-12">
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6 md:px-8">
                <div className="max-w-md">
                    <h1 className="text-gray-800 dark:text-white text-lg sm:text-xl md:text-2xl font-extrabold">
                ...
                <div className="mt-8 sm:mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    {difficulties.map((item, idx) => (
                        <button
                            ...
                            className={`w-full text-left border dark:border-gray-700 rounded-lg 
                                ...
                                ${difficulty === item.title ? "border-indigo-600 bg-gray-100 dark:bg-gray-800 dark:border-indigo-500" : "bg-white dark:bg-gray-900"}
                            `}
                        >
                            <div className="flex items-start justify-between p-3 sm:p-4">
                                <div className="space-y-1 sm:space-y-2">
                                    ...
                                    <h4 className="text-gray-800 dark:text-white font-semibold text-base sm:text-lg">
                                        {item.title}
                                    </h4>
