...
const QuizConfigurator = () => {
    ...
    const optionButtons = [
        ...
        <div className="max-w-md mx-auto px-4 space-y-8">
            <h2 className="text-gray-800 dark:text-white text-xl font-medium">Configure Your Quiz</h2>
                
                {/* Options Selection */}
                <div className="space-y-4">
                    <h3 className="text-gray-700 dark:text-gray-300 font-medium">Number of Options</h3>
                        ...
                        {optionButtons.map((item, idx) => (
                            <li key={idx}>
                                <label className="block relative">
                                    ...
                                    />
                                    <div className={`w-full p-3 text-center cursor-pointer rounded-lg border dark:border-gray-700 bg-white dark:bg-gray-800 dark:text-gray-200 shadow-sm 
