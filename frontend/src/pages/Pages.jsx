                ...
                <div className="max-w-screen-xl mx-auto text-gray-600 dark:text-gray-300 gap-x-12 items-center justify-between overflow-hidden md:flex md:px-8">
                    <div className="flex-none space-y-5 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
                        ...
                        <p>
                            ...
                            <button 
                                className="flex items-center justify-center gap-x-2 py-2 px-4 text-gray-700 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-100 font-medium duration-150 active:bg-gray-100 dark:active:bg-gray-800 border dark:border-gray-700 rounded-lg md:inline-flex" 
                            ...
                            >
                                ...
                                className="flex items-center justify-center gap-x-2 py-2 px-4 text-gray-700 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-100 font-medium duration-150 active:bg-gray-100 dark:active:bg-gray-800 border dark:border-gray-700 rounded-lg md:inline-flex bg-indigo-100 dark:bg-indigo-900/40 hover:bg-indigo-200 dark:hover:bg-indigo-900/60" 
