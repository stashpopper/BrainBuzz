...
const MyQuizzes = () => {
  ...
  return (
    <>
      <Nav />
      <section className="py-14 bg-gray-50 dark:bg-gray-950 min-h-screen">
          ...
          <div className="mt-8 max-w-md mx-auto">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 rounded-lg border dark:border-gray-700 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-colors duration-200 dark:bg-gray-900 dark:text-white"
              />
              <svg
          ...
          {loading ? (
            ...
            <div className="mt-16 space-y-6 justify-center gap-6 sm:grid sm:grid-cols-2 sm:space-y-0 lg:grid-cols-3">
              {quizzes
                ...
                .map((quiz, idx) => (
                <div key={idx} className="relative flex-1 flex items-stretch flex-col p-8 rounded-xl border-2 dark:border-gray-800 hover:border-indigo-500 dark:hover:border-indigo-400 transition-all duration-300 bg-white dark:bg-gray-900">
                  <div>
                    <span className="text-indigo-600 font-medium">
                      Quiz #{idx + 1}
                    </span>
                    <div className="mt-4 text-gray-800 dark:text-white text-2xl font-semibold">
                  ...
                  <div className="py-8">
                    ...
                    <div className="mt-3 flex items-center gap-3 text-gray-800 dark:text-gray-300">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="mt-16 text-center">
              <p className="text-gray-500 dark:text-gray-400 text-lg">You haven't created any quizzes yet.</p>
            </div>
          )}
        </div>
      </section>
